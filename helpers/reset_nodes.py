...
def reset_nodes(node_addresses : typing.List[str], remove_delay_packet_loss : bool = False) -> None:
  '''
  resets the nodes
  ...
  '''
  reset_cmd : str = f'killall etcd && sudo {REMOVE_DELAY_PACKET_LOSS}' if remove_delay_packet_loss else 'killall etcd'

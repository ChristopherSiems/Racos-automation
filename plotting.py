...
ALG_VANITY_WRITE : typing.Dict[str, typing.Tuple[typing.Union[str, float]]] = {
  'racos' : ('C1', -.3),
  'tracos' : ('C2', None),
  'paxos' : ('C3', -.1),
  'rabia' : ('C4', .1),
...
def data_size_discrete_5_write_95_read() -> None:
  ...
  data : pandas.DataFrame = setup_dataframe(pandas.read_csv(f'data/data_size-discrete-5_write_95_read.csv'))
  ...
  pyplot.tight_layout()
  pyplot.savefig(f'plots/data_size-discrete-5_write_95_read/data_size-throughput-5_write_95_read.png')
  ...
  pyplot.tight_layout()
  pyplot.savefig(f'plots/data_size-discrete-5_write_95_read/data_size-latency-5_write_95_read.png')
  ...
  pyplot.legend(handles = LINE_LEGEND_READ, loc = 'upper left')
  pyplot.tight_layout()
  pyplot.savefig(f'plots/data_size-discrete-5_write_95_read/data_size-throughput-5_write_95_read-loss.png')
  ...
  pyplot.legend(handles = BAR_LEGEND_READ, loc = 'upper left')
  pyplot.tight_layout()
  pyplot.savefig(f'plots/data_size-discrete-5_write_95_read/data_size-latency-5_write_95_read-loss.png')
...
def data_size_discrete_all_read() -> None:
  ...
  data : pandas.DataFrame = setup_dataframe(pandas.read_csv(f'data/data_size-discrete-all_read.csv'))
  ...
  pyplot.legend(handles = LINE_LEGEND_READ, loc = 'upper left')
  pyplot.tight_layout()
  pyplot.savefig(f'plots/data_size-discrete-all_read/data_size-throughput-all_read.png')
  ...
  pyplot.legend(handles = BAR_LEGEND_READ, loc = 'upper left')
  pyplot.tight_layout()
  pyplot.savefig(f'plots/data_size-discrete-all_read/data_size-latency-all_read.png')
...
def data_size_discrete_all_write() -> None:
  ...
  pyplot.tight_layout()
  pyplot.savefig(f'plots/data_size-discrete-all_write/data_size-throughput-all_write.png')
...
def data_size_discrete_half_write_half_read() -> None:
  ...
  data : pandas.DataFrame = setup_dataframe(pandas.read_csv(f'data/data_size-discrete-half_write_half_read.csv'))
  ...
  pyplot.legend(handles = LINE_LEGEND_READ, loc = 'upper left')
  pyplot.tight_layout()
  pyplot.savefig(f'plots/data_size-discrete-5_write_95_read/data_size-throughput-half_write_half_read.png')
  ...
  pyplot.legend(handles = BAR_LEGEND_READ, loc = 'upper left')
  pyplot.tight_layout()
  pyplot.savefig(f'plots/data_size-discrete-5_write_95_read/data_size-latency-half_write_half_read.png')
  ...
  pyplot.legend(handles = LINE_LEGEND_READ, loc = 'upper left')
  pyplot.tight_layout()
  pyplot.savefig(f'plots/data_size-discrete-5_write_95_read/data_size-throughput-half_write_half_read-loss.png')
  ...
  pyplot.legend(handles = BAR_LEGEND_READ, loc = 'upper left')
  pyplot.tight_layout()
  pyplot.savefig(f'plots/data_size-discrete-5_write_95_read/data_size-latency-half_write_half_read-loss.png')
...
def threads_discrete_5_write_95_read() -> None:
  ...
  data : pandas.DataFrame = setup_dataframe(pandas.read_csv(f'data/threads-discrete-5_write_95_read.csv'))
  ...
  pyplot.legend(handles = LINE_LEGEND_READ, loc = f'upper right')
  pyplot.tight_layout()
  pyplot.savefig(f'plots/threads-discrete-5_write_95_read/throughput-med_latency-5_write_95_read.png')
  ...
  pyplot.legend(handles = LINE_LEGEND_READ, loc = f'upper right')
  pyplot.tight_layout()
  pyplot.savefig(f'plots/threads-discrete-5_write_95_read/throughput-p99_latency-5_write_95_read.png')
...
def threads_discrete_half_write_half_read() -> None:
  ...
  data : pandas.DataFrame = setup_dataframe(pandas.read_csv(f'data/threads-discrete-half_write_half_read.csv'))
  ...
  pyplot.legend(handles = LINE_LEGEND_READ, loc = f'upper right')
  pyplot.tight_layout()
  pyplot.savefig(f'plots/threads-discrete-half_write_half_read/throughput-p99_latency-half_write_half_read.png')
